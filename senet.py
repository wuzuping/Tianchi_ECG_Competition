...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
                 ...
                 downsample_padding=1, num_classes=34):
        """
        Parameters
        ----------
        ...
        if input_3x3:
            layer0_modules = [
                ('conv1', nn.Conv1d(12, 64, 3, stride=2, padding=1,
                                    bias=False)),
            ...
            layer0_modules = [
                ('conv1', nn.Conv1d(12, inplanes, kernel_size=7, stride=2,
...
def senet154(num_classes=34, pretrained='imagenet'):
